...
面向约 250–300 人规模模拟联合国会议设计的多角色报名与信息管理平台。项目于 2026 年 1–3 月从 v0.1 迭代至 v3.5 并完成服务器部署；早期版本通过小范围测试收集反馈，后续正式使用阶段实际服务 237 名代表，承载从信息提交、领队初审到管理员终审、会场分配和付款审核的业务流程。
...
> 事实边界：250–300 人是目标会议规模；237 名代表是项目负责人确认的实际使用规模，仍待补充不含个人信息的聚合证据。该数字不代表并发量或性能测试结果，仓库也不包含任何真实报名数据。
